...
000000000027c700 <PyInit__native>:
  ...
  27c8b7: 48 c7 43 18 00 00 00 00      	movq	$0x0, 0x18(%rbx)
  27c8bf: 48 8b 43 20                  	movq	0x20(%rbx), %rax
  27c8c3: 48 89 44 24 10               	movq	%rax, 0x10(%rsp)
  27c8c8: 48 89 44 24 18               	movq	%rax, 0x18(%rsp)
  27c8cd: 48 c7 44 24 20 00 10 00 00   	movq	$0x1000, 0x20(%rsp)     # imm = 0x1000
  27c8d6: 48 c7 44 24 28 00 00 00 00   	movq	$0x0, 0x28(%rsp)
  27c8df: 48 c7 44 24 30 00 10 00 00   	movq	$0x1000, 0x30(%rsp)     # imm = 0x1000
  27c8e8: 48 8b 85 50 04 00 00         	movq	0x450(%rbp), %rax
  27c8ef: 48 83 c0 10                  	addq	$0x10, %rax
