...
000000000027ab00 <PyInit__native>:
  ...
  27acb0: 48 89 58 08                  	movq	%rbx, 0x8(%rax)
  27acb4: 48 c7 40 10 8b 00 00 00      	movq	$0x8b, 0x10(%rax)
  27acbc: 66 41 c7 06 0a 00            	movw	$0xa, (%r14)
  27acc2: 49 89 46 08                  	movq	%rax, 0x8(%r14)
  27acc6: 48 8d 05 23 c7 83 00         	leaq	0x83c723(%rip), %rax    # 0xab73f0
  27accd: 49 89 46 10                  	movq	%rax, 0x10(%r14)
  27acd1: 48 83 c4 08                  	addq	$0x8, %rsp
  27acd5: 5b                           	popq	%rbx
  27acd6: 41 5e                        	popq	%r14
  27acd8: c3                           	retq
  27acd9: bf 08 00 00 00               	movl	$0x8, %edi
  27acde: be 18 00 00 00               	movl	$0x18, %esi
  27ace3: e8 5a 0c 0c 00               	callq	0x33b942 <PyInit__native+0xc0e42>
  27ace8: 0f 0b                        	ud2
  27acea: bf 01 00 00 00               	movl	$0x1, %edi
  27acef: be 8b 00 00 00               	movl	$0x8b, %esi
